...
TEAM_INFO = {
    "ARS": {
        ...
        "style": "유려한 패스 연결 · 조직적 압박 · 포지셔널 플레이",
        "desc": "아르센 벵거의 아름다운 축구 철학이 뿌리내린 클럽. 2003-04 무패 우승(인빈시블즈) 이후 20여 년 만에 2025-26 시즌 EPL 우승을 탈환하며 드디어 정상에 복귀했다. 아르테타의 치밀한 전술과 사카, 외데고르, 하베르츠 등 황금 세대가 만들어낸 역사적 시즌.",
        "reason": "전술을 분석하며 경기를 즐기는 당신에게, Arsenal의 지능적인 패스 축구는 매 경기가 하나의 퍼즐이 될 거예요. 20년 만에 리그 정상에 복귀한 팀의 다음 여정을 함께하세요.",
    ...
    "CHE": {
        ...
        "desc": "UCL 2회, EPL 6회 우승의 런던 대표 클럽. 2025-26 시즌은 감독 교체가 잦았던 혼란기였으나, 시즌 막바지 레버쿠젠 무패 우승의 주역 샤비 알론소 감독을 선임하며 새 시대를 열었다. 콜 팔머, 엔소 페르난데스 등 핵심 자원과 함께 재건에 나선다.",
        "reason": "화려하고 세련된 것에 끌리는 당신에게, Chelsea의 글로벌 브랜드와 스타 선수들의 개인기는 최고의 엔터테인먼트를 선사할 거예요. 샤비 알론소의 새로운 축구와 콜 팔머의 천재적 플레이를 주목하세요.",
    ...
    "LIV": {
        ...
        "style": "조직적 빌드업 · 유연한 전술 변환 · 강력한 스쿼드 깊이",
        "desc": '"You\'ll Never Walk Alone" — 전 세계 축구 찬가의 원조. UCL 6회, 리그 우승 20회. 아르네 슬롯 감독 부임 첫 해(2024-25) EPL 우승을 달성했고, 이삭·비르츠·프림퐁 등 대형 영입으로 스쿼드를 대폭 강화했다.',
        "reason": "감정을 함께 나누고 뜨거운 응원 문화를 원하는 당신에게, 안필드의 YNWA 제창 순간은 평생 잊지 못할 경험이 될 거예요. 슬롯 감독의 새로운 축구와 살라·이삭·비르츠의 공격 조합을 지켜보세요.",
    ...
    "MCI": {
        ...
        "style": "완벽한 포지셔널 플레이 · 지배적 점유율",
        "desc": "펩 과르디올라가 구현한 현대 축구의 완성형. 2022-23 트레블 달성. 데이터 사이언스와 전술의 결합으로 EPL을 지배 중인 팀.",
    ...
    "MNU": {
        ...
        "style": "공격적 드라마틱 역전 DNA · 퍼기 타임의 전통",
        "desc": "알렉스 퍼거슨 경의 26년 황금기. EPL 최다 우승 20회, UCL 3회. 세계 최대 팬덤의 클럽. 2026년 1월 아모림 후임으로 부임한 마이클 캐릭 감독이 반 시즌 만에 3위·UCL 진출을 이끌며 정식 감독으로 선임되었다. 브루노 페르난데스가 PL 단일 시즌 최다 도움(21개) 신기록을 세우며 올해의 선수에 선정.",
        "reason": "역사와 레전드, 드라마틱한 순간들에 끌리는 당신. Old Trafford라는 이름 하나만으로 세계 어디서나 통하는 자부심을 느낄 수 있어요. 캐릭 감독과 함께 시작된 부활의 스토리를 지켜보세요.",
    ...
    "TOT": {
        ...
        "style": "아름답고 공격적인 축구 · 예측 불가능한 스퍼스 웨이",
        "desc": "2025-26 시즌 감독 3번 교체와 강등 위기라는 클럽 역사상 최악의 시련을 겪었지만, 시즌 막판 데 제르비 감독의 부임으로 극적 잔류에 성공했다. 손흥민은 2025년 LAFC로 이적했지만, 로메로 주장을 중심으로 재건을 시작한다.",
    ...
    "NEW": {
        ...
        "desc": "사우디 컨소시엄 인수(2021) 이후 급성장했으나, 2025-26 시즌 이삭(리버풀)과 고든(바르셀로나)이 이적하며 재건기에 돌입했다. St. James' Park의 팬 분위기는 여전히 EPL 최고 수준. 에디 하우 감독 아래 새로운 도약을 준비 중.",
        "reason": "거칠고 뜨거운 팬 문화와 언더독의 성장 스토리에 끌리는 당신. 핵심 선수를 잃었지만 다시 일어서는 Newcastle 팬들의 충성심은 세계 최고예요.",
    ...
    "AVL": {
        ...
        "style": "전술적 조직 공격 · 젊고 역동적인 스쿼드",
        "desc": "영국에서 가장 오래된 클럽 중 하나 (1874년 창단). 1982 유러피언컵(현 UCL) 우승. 우나이 에메리의 전술 마법으로 UCL 복귀에 이어 2025-26 시즌 유로파리그 우승까지 달성하며 유럽 무대에서 화려하게 부활했다.",
...
QUESTIONS = [
    ...
    {"q": "가장 보고 싶은 축구 스타일은?",
     "choices": [("🎯","한 치의 오차도 없는 완벽한 패스워크와 압도적 점유율"),("⚡","빈 공간을 찌르는 날카로운 역습과 카운터어택"),("🔥","전원이 미친 듯이 달려드는 하이프레스 축구"),("🎨","선수 개인의 창의성이 폭발하는 자유로운 축구")],
    ...
    {"q": "끌리는 구단주·경영 스타일은?",
     "choices": [("🏦","중동 자본의 막대한 투자로 팀을 키우는 방식"),("💼","미국식 스포츠 비즈니스, 브랜드와 수익 극대화"),("🤝","팬과 지역사회를 최우선으로 생각하는 운영"),("📉","적자 없이 재정 건전성을 유지하며 성장하는 운영")],
    ...
    {"q": "팀의 글로벌 이미지로 가장 중요한 것은?",
     "choices": [("🌍","전 세계 어디서나 알아보는 초대형 브랜드 파워"),("🏘️","지역 커뮤니티와 뿌리 깊은 유대감"),("📱","SNS와 마케팅으로 아시아·글로벌 팬과 소통"),("📈","실력으로 조용히 증명해서 점점 인정받는 클럽")],
    ...
    {"q": "가장 가슴 뛰는 팀의 현재 상황은?",
     "choices": [("🏆","오랜 기다림 끝에 드디어 정상에 선 챔피언"),("👑","매년 우승을 다투는 압도적 강자"),("🔄","어둠을 지나 부활의 기지개를 켜는 재건 중인 명문"),("🚀","바닥에서부터 올라오는 언더독의 성장 스토리")],
    ...
    {"q": "가장 좋아하는 라이벌전의 느낌은?",
     "choices": [("🔥","같은 도시 팀끼리의 자존심 싸움"),("⚔️","역사가 얽힌 숙명의 라이벌"),("🌋","지역 전체의 자부심이 걸린 로컬 더비"),("🏆","1위 vs 2위, 정상을 건 빅매치")],
    ...
    {"q": "내 성격에 가장 가까운 것은?",
     "choices": [("📊","계획적이고 분석적이다. 감정보다 논리가 앞선다"),("🔥","감정적이고 열정적이다. 온몸으로 느끼며 산다"),("✨","화려하고 세련된 것에 끌린다. 트렌드를 따른다"),("🪨","조용히 끈기 있게 자기 길을 가는 편이다")],
    ...
    {"q": "가장 흥미로운 스타 선수 유형은?",
     "choices": [("🎯","경기를 읽는 천재 플레이메이커"),("💨","상대 수비를 혼자 돌파하는 드리블러"),("🦁","골 앞에서 본능이 폭발하는 스트라이커"),("🛡️","팀을 위해 보이지 않는 곳에서 뛰는 영웅")],
...
<div style="text-align:center;padding:2rem 0 1rem 0">
  ...
  <p style="color:rgba(255,255,255,0.85);font-size:1rem;max-width:460px;margin:0 auto 2rem auto;line-height:1.7;text-shadow:0 1px 4px rgba(0,0,0,0.5)">
    축구를 처음 보기 시작했나요?<br>
    20가지 질문으로 당신의 <b style="color:#C4B5FD">축구 DNA</b>에 꼭 맞는 팀을 찾아드려요.
  </p>
</div>
""", unsafe_allow_html=True)
...
""", unsafe_allow_html=True)
    ...
    if match_pct is not None:
        st.markdown(f"<h3 style='margin-bottom:0.5rem'>🎯 매칭률</h3>", unsafe_allow_html=True)
...
""", unsafe_allow_html=True)
    ...
    if yt_id:
        st.markdown("<h3>🎬 25-26 시즌 최고의 경기</h3>", unsafe_allow_html=True)
        components.html(f"""
...
<div style="background:#F8FAFC;border:1px solid #E2E8F0;
            border-radius:14px;padding:1.2rem">
  <p style="color:#94A3B8;font-size:0.72rem;letter-spacing:0.1em;margin:0 0 0.5rem 0">플레이 스타일</p>
...
""", unsafe_allow_html=True)
    ...
    with tab2:
        ...
        st.markdown("<br>", unsafe_allow_html=True)
        for label, val in zip(RADAR_LABELS, info["radar"]):
            ...
            st.markdown(f"<p style='color:#64748B;font-size:0.78rem;margin:-0.3rem 0 0.6rem 0'>{label}</p>", unsafe_allow_html=True)

    st.divider()

    # ── All Team Rankings (quiz only) ──
    if scores is not None:
        st.markdown("<h3>📊 전체 팀 매칭률 순위</h3>", unsafe_allow_html=True)
